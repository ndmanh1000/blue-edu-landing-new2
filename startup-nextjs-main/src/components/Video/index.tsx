                ...
                >
                  ...
                  <div className="relative w-full md:w-1/2 p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="text-sm leading-relaxed text-black dark:text-body-color-dark sm:text-base md:text-lg">
                        {feature.description.split('.').filter(sentence => sentence.trim()).map((sentence, idx) => (
